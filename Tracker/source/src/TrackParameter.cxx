// RS: this is a standalone version of AliRoot AliExternalTrackParameteram
...
ClassImp(TrackParameter)

Double32_t TrackParameter::fgMostProbablePt=kMostProbablePt;
Bool_t TrackParameter::fgUseLogTermMS = kFALSE;; 
...
//_____________________________________________________________________________
TrackParameter::TrackParameter(const TrackParameter &track):
  TObject(track),
  fX(track.fX),
  fAlpha(track.fAlpha)
{
...
//_____________________________________________________________________________
TrackParameter& TrackParameter::operator=(const TrackParameter &trkPar)
{
  //
  // assignment operator
  //
...
//_____________________________________________________________________________
TrackParameter::TrackParameter(Double_t x, Double_t alpha, 
...
//_____________________________________________________________________________
TrackParameter::TrackParameter(Double_t xyz[3],Double_t pxpypz[3],
...
/*
//_____________________________________________________________________________
void TrackParameter::Set(Double_t xyz[3],Double_t pxpypz[3],
				Double_t cv[21],Short_t sign) 
{
  //
...
//_____________________________________________________________________________
void TrackParameter::AddCovariance(const Double_t c[15]) {
  //
...
Double_t TrackParameter::GetP() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Get1P() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::GetD(Double_t x,Double_t y,Double_t b) const {
  //------------------------------------------------------------------
...
//_______________________________________________________________________
Double_t TrackParameter::GetLinearD(Double_t xv,Double_t yv) const {
  //------------------------------------------------------------------
  // This function calculates the transverse impact parameter
...
Bool_t TrackParameter::CorrectForMeanMaterialdEdx
...
Bool_t TrackParameter::CorrectForMeanMaterial
(Double_t xOverX0,  Double_t xTimesRho, Double_t mass, 
 Bool_t anglecorr,
...
Bool_t TrackParameter::CorrectForMeanMaterialZA
(Double_t xOverX0, Double_t xTimesRho, Double_t mass,
 Double_t zOverA,
 Double_t density,
 Double_t exEnergy,
...
Bool_t TrackParameter::CorrectForMaterial
...
Double_t TrackParameter::BetheBlochAleph(Double_t bg,
         Double_t kp1,
         Double_t kp2,
         Double_t kp3,
         Double_t kp4,
...
Double_t TrackParameter::BetheBlochGeant(Double_t bg,
         Double_t kp0,
         Double_t kp1,
         Double_t kp2,
         Double_t kp3,
...
Double_t TrackParameter::BetheBlochSolid(Double_t bg) {
  //------------------------------------------------------------------
...
Double_t TrackParameter::BetheBlochGas(Double_t bg) {
  //------------------------------------------------------------------
  // This is an approximation of the Bethe-Bloch formula, 
...
Bool_t TrackParameter::Rotate(Double_t alpha) {
  //------------------------------------------------------------------
...
Bool_t TrackParameter::RotateParamOnly(Double_t alpha)
{
...
Bool_t TrackParameter::PropagateTo(Double_t xk, Double_t b) {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::PropagateParamOnlyTo(Double_t xk, Double_t b) {
  //----------------------------------------------------------------
  // Propagate this track to the plane X=xk (cm) in the field "b" (kG)
...
Bool_t 
TrackParameter::Propagate(Double_t alpha, Double_t x, Double_t b) {
  //------------------------------------------------------------------
  // Transform this track to the local coord. system rotated
  // by angle "alpha" (rad) with respect to the global coord. system, 
...
Bool_t TrackParameter::PropagateBxByBz
...
void TrackParameter::Propagate(Double_t len, Double_t x[3],
...
Bool_t TrackParameter::Intersect(Double_t pnt[3], Double_t norm[3],
Double_t bz) const {
  //+++++++++++++++++++++++++++++++++++++++++    
  // Origin: K. Shileev (Kirill.Shileev@cern.ch)
...
Double_t 
TrackParameter::GetPredictedChi2(const Double_t p[2],const Double_t cov[3]) const {
  //----------------------------------------------------------------
...
Double_t TrackParameter::
GetPredictedChi2(const TrackParameter *t) const {
  //----------------------------------------------------------------
...
Double_t *TrackParameter::GetResiduals(
...
Bool_t TrackParameter::Update(const Double_t p[2], const Double_t cov[3]) {
  //------------------------------------------------------------------
...
void 
TrackParameter::GetHelixParameters(Double_t hlx[6], Double_t b) const {
  //--------------------------------------------------------------------
...
Double_t TrackParameter::GetDCA(const TrackParameter *p, 
...
Double_t TrackParameter::
PropagateToDCA(TrackParameter *p, Double_t b) {
  //--------------------------------------------------------------
...
void TrackParameter::GetDirection(Double_t d[3]) const {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::GetPxPyPz(Double_t p[3]) const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Px() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Py() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Xv() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Yv() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::Theta() const {
  // return theta angle of momentum

  return 0.5*TMath::Pi() - TMath::ATan(fP[3]);
}

Double_t TrackParameter::Phi() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::PhiPos() const {
  //---------------------------------------------------------------------
...
Double_t TrackParameter::M() const {
...
Double_t TrackParameter::E() const {
...
Double_t TrackParameter::Eta() const { 
  // return pseudorapidity

  return -TMath::Log(TMath::Tan(0.5 * Theta())); 
}

Double_t TrackParameter::Y() const {
  // return rapidity
...
Bool_t TrackParameter::GetXYZ(Double_t *r) const {
  //---------------------------------------------------------------------
...
Bool_t TrackParameter::GetCovarianceXYZPxPyPz(Double_t cv[21]) const {
  //---------------------------------------------------------------------
...
Bool_t 
TrackParameter::GetPxPyPzAt(Double_t x, Double_t b, Double_t *p) const {
  //---------------------------------------------------------------------
...
Bool_t 
TrackParameter::GetYAt(Double_t x, Double_t b, Double_t &y) const {
  //---------------------------------------------------------------------
...
Bool_t 
TrackParameter::GetZAt(Double_t x, Double_t b, Double_t &z) const {
  //---------------------------------------------------------------------
...
Bool_t 
TrackParameter::GetXYZAt(Double_t x, Double_t b, Double_t *r) const {
  //---------------------------------------------------------------------
...
//_____________________________________________________________________________
void TrackParameter::Print(Option_t* /*option*/) const
{
// print the parameters and the covariance matrix

  printf("TrackParameter: x = %-12g  alpha = %-12g\n", fX, fAlpha);
...
Double_t TrackParameter::GetSnpAt(Double_t x,Double_t b) const {
  //
...
Bool_t TrackParameter::GetDistance(TrackParameter *param2, Double_t x, Double_t dist[3], Double_t bz){
  //------------------------------------------------------------------------
...
void  TrackParameter::DrawTrack(Float_t magf, Float_t minR, Float_t maxR, Float_t stepR){
  //
  // Draw track line
  //
  if (minR>maxR) return ;
...
//
void TrackParameter::FillPolymarker(TPolyMarker3D *pol, Float_t magF, Float_t minR, Float_t maxR, Float_t stepR){
  //
...
Int_t TrackParameter::GetIndex(Int_t i, Int_t j){
  //
...
void TrackParameter::g3helx3(Double_t qfield, 
                                    Double_t step,
                                    Double_t vect[7]) {
/******************************************************************
 *                                                                *
...
Bool_t TrackParameter::PropagateToBxByBz(Double_t xk, const Double_t b[3]) {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::PropagateParamOnlyBxByBzTo(Double_t xk, const Double_t b[3]) {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::Translate(Double_t *vTrasl,Double_t *covV){
  //
...
void TrackParameter::CheckCovariance() {
...
Bool_t TrackParameter::GetXatLabR(Double_t r,Double_t &x, Double_t bz, Int_t dir) const
{
...
Bool_t TrackParameter::GetXYZatR(Double_t xr,Double_t bz, Double_t *xyz, Double_t* alpSect) const
{
...
Double_t  TrackParameter::GetParameterAtRadius(Double_t r, Double_t bz, Int_t parType) const
{
  //
...
Bool_t TrackParameter::Local2GlobalMomentum(Double_t p[3], Double_t alpha) const {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::Local2GlobalPosition(Double_t r[3], Double_t alpha) const {
  //----------------------------------------------------------------
  // This function performs local->global transformation of the
  // track position.
  // When called, the arguments are:
...
Bool_t TrackParameter::Global2LocalMomentum(Double_t p[3], Short_t charge, Double_t &alpha) const {
  //----------------------------------------------------------------
...
Bool_t TrackParameter::Global2LocalPosition(Double_t r[3], Double_t alpha) const {
