...
//====================================================================
class Material :public TMaterial {
public:
  /// changed from 2 to 3 by Arka
  enum {kNELossPar=3};
  Material();
  Material(const char* name, const char *title, 
 ...
 protected:
  ...
  //
  ClassDef(Material,1) // Material Object
};

//==========================================================================
class NaMixture :public Material {
public:
  NaMixture();
