...
class TrackParameter: public TObject {
 public:
  TrackParameter();
  TrackParameter(const TrackParameter &);
  TrackParameter& operator=(const TrackParameter & trkPar);
  TrackParameter(Double_t x, Double_t alpha, 
			const Double_t param[5], const Double_t covar[15]);
  TrackParameter(Double_t xyz[3],Double_t pxpypz[3],
  ...
  Bool_t CorrectForMeanMaterial(Double_t xOverX0, Double_t xTimesRho, 
	...
	Double_t (*f)(Double_t)=TrackParameter::BetheBlochSolid);
  ...
  Double_t GetPredictedChi2(const TrackParameter *t) const;
  ...
  Double_t GetDCA(const TrackParameter *p, Double_t b,
    Double_t &xthis,Double_t &xp) const;
  Double_t PropagateToDCA(TrackParameter *p, Double_t b);
  ...
  Bool_t GetDistance(TrackParameter *param2, Double_t x, Double_t dist[3], Double_t b);
  ...
  //-----------
  virtual Int_t GetTrackParameteram         ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramRefitted ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramIp       ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramTPCInner ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramOp       ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramCp       ( TrackParameter & ) const {return 0;}
  virtual Int_t GetTrackParameteramITSOut   ( TrackParameter & ) const {return 0;}
  //
...
/*  protected: */
 ...
 protected:
  ...
  ClassDef(TrackParameter, 8)
};

inline void TrackParameter::ResetCovariance(Double_t s2) {
  //
